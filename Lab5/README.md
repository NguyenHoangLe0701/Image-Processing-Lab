...
<div align="center">
  <img src="input/QR.png" alt="Mã QR trải nghiệm ứng dụng" width="250" />
  <p><em>Quét mã QR bên trên để truy cập và trải nghiệm ứng dụng NeuraMatch Studio trên điện thoại của bạn!</em></p>
  <p>🌐 <strong>Hoặc truy cập trực tiếp: <a href="https://neuramatch-studio.vercel.app">https://neuramatch-studio.vercel.app</a></strong></p>
</div>
